...
export default () => {
  ...
  return <div>
    ...
    <Box direction="column" style={{maxWidth: '800px'}}>
      ...
      <Box direction={"row"}>
        <Box basis="1/3" pad="small"><Text>Name</Text></Box>
      ...
      <Box direction={"row"}>
        <Box basis="1/3" pad="small"><Text>Type</Text></Box>
        <Box basis="2/3" pad="small">
          <TextInput value={state.type.value} onChange={formLeaf.branch('type').do.update} />
        </Box>
      </Box>

      <Box direction={"row"}>
        <Box basis="1/3" pad="small"><Text>Description</Text></Box>
        <Box basis="2/3" pad="small">
